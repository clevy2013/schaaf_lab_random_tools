...
os.chdir('/muddy/data01/arthur.elmes/above/2017/mcd43/tif/mcd43a3/wsa')
...
for day in doys:
    tif_list = glob.glob('MCD43A3.A2017%03d*wsa_shortwave.tif' % day)
    if len(tif_list) == 0:
        print('File not found: MCD43A3.A2017%03d*wsa_shortwave.tif' % day)
        pass
    else:
        tif = tif_list[0]
    # Open tif as gdal ds
...
ax.set_xlabel('2017 Julian DOY')
ax.set_ylabel('White Sky Albedo')
ax.plot(doys, alb_swir_mean)
plt.savefig('/home/arthur.elmes/code/test.png')
