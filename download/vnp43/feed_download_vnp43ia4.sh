...
url_base=https://e4ftl01.cr.usgs.gov/VIIRS/VNP43IA4
vers=.001

base_dir=/muddy/data01/arthur.elmes/above/${start_date:0:4}/vnp43ia4/
dl_dir=/muddy/data01/arthur.elmes/above/${start_date:0:4}/vnp43ia4/${tile_id}
