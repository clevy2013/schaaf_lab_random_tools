...
do
    ...
    gdalwarp --config CENTER_LONG 180 -t_srs '+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs' -te -140 15 -50 55 -of HDF4Image -srcnodata 32767 -dstnodata 32767  $hdf ${out_dir}/${filename_bare}.hdf
